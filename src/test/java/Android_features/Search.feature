...
Then User enter the text and check the presence of the X button
...
#Executes in EN,FR,NL
@Search
Scenario: Bottom bar navigation is present on top of device keyboard on clicking on Search in the Homescreen
Given The User is on search page
When Bottom navigation bar is "visible"
...
Given The User is on search page
When User search for a text using suggestion
...
@Search
Scenario: Validate 'TV Shows' and 'On Demand' categories in landscape mode
Given The User is on search page
When User search for a program title
Then The appropriate results are shown for program
And User verifies TV Shows and On Demand
Then The User rotate the oriantation to landscape
And User clears search box
When User search for a program title
Then The appropriate results are shown for program
And User verifies TV Shows and On Demand
