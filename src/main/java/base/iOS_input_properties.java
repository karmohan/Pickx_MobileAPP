...
public class iOS_input_properties {

	protected Properties prop;
	protected FileInputStream file = new FileInputStream(
			System.getProperty("user.dir") + "/src/test/resources/iOS_input.properties");

	public iOS_input_properties() throws IOException {
		prop = new Properties();
		prop.load(file);
	}
	...
	public String getnewPinSecond() {
		return prop.getProperty("newPinSecond");
	}
	...
	public String getemail() {
        ...
        public String getOfflineText() {
    		return prop.getProperty("offline_Text");
        }
}
